...
namespace AzureCognitiveServices
{
    ...
    {
        /// <summary>
        /// Audio stream of the last requested text.
        /// </summary>
        /// <value>
        /// The stream.
        /// </value>
        ...
        /// <summary>
        /// Generates the speech from input text, with the default settings.
        /// </summary>
        /// <param name="text">The text.</param>
        /// <param name="SpeakOut">if set to <c>true</c> [speak out the given text. Used for testing].</param>
        /// <returns></returns>
        public async Task<TextToSpeechDto> GenerateSpeechWithDefaultSettings(string text, bool SpeakOut = false)
        {
            Authentication auth = new Authentication(baseUri, accessToken);
            ...
            var cortana = new TextToSpeechManager();


            InputOptions inputOptions = new TextToSpeechManager.InputOptions()
            {
            ...
            await cortana.Speak(CancellationToken.None, inputOptions);



            if (SpeakOut)
            {
                SoundPlayer player = new SoundPlayer(cortana.Stream);
                player.PlaySync();
                //cortana.Stream.Dispose();
            }

            return new TextToSpeechDto
            {
                Text = text,
                BytesData = StreamToBytes(cortana.Stream)
            };
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TextToSpeechManager"/> class.
        /// </summary>
        ...
        private Task Speak(CancellationToken cancellationToken, InputOptions inputOptions)
        {
        ...
        internal string accessToken = "832d6aa5cc8746e78d78999bee92bdbe";
        internal const string baseUri = "https://westus.api.cognitive.microsoft.com/sts/v1.0/issueToken";
    }
}